export default function ContactSectionSecond() {
    return (
        ...
        <div className="container-fluid">
           <div className="row">
              ...
              <div className="col-md-6 padding_0">
                 ...
                 <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&q=Eiffel+Tower+Paris+France" width="600" height="508" ></iframe>
                 </div>
              </div>
           </div>
        </div>
